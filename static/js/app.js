...
import {initServerAITracking} from './server-ai-tracking.js';
...
const initializers=[initNavigation,initContent,initHomepageV11Merge,initRoleLens,initCameras,initPanorama,initHologramAnalysis,initSmallPlayerDetection,initPanoramaTwin,initLive3DTwin,initPanoramaWorkspaceV2,initServerAITracking,initTwin,initSimulation];
